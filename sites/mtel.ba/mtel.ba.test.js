...
it('can handle empty guide', () => {
  const result = parser({
    ...
    channel,
    content:
      '{"message":"Tra\u017eeni termin nije prona\u0111en.\u003Cbr\u003E\u003Cbr\u003EProverite da li ste upisali pravilno ili poku\u0161ajte sa nekim drugim terminom."}'
  })
  expect(result).toMatchObject([])
})
